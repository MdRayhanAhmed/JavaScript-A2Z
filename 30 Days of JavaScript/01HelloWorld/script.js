...
// Function Syntax -Solution-01
var createHelloWorld = function () {
    return function () {
        return "Hello World";
    }
};
// Arrow Syntax -Solution-02
var createHelloWorld = function () {
    return () => "Hello World";
};
// Arrow Syntax + Rest Arguments -Solution-03
var createHelloWorld = function () {
    return (...args) => "Hello World";
};

// --------------------------------------------------
//Some Importent Logic
// Basic Syntax
function f(a, b) {
    const sum = a + b;
    return sum;
...
// used before it is initialized. You can only do this if you declare functions with 
// the function syntax.
...
// Although it is valid syntax, it is sometimes considered bad practice as 
...
// Arrow Syntax
// The other common way to declare functions is with arrow syntax. In fact, 
// on many projects, it is the preferred syntax.
...
// You can write any logic in the body and finally return a result. You are allowed
//  to return nothing, and it will instead implicitly return undefined.
...
//  and single-line functions. For this reason, this way is generally preferred
//   when passing short anonymous functions to other functions.
// No automatic hoisting. You are only allowed to use the function after it 
// was declared. This is generally considered a good thing for readability.
// Can't be bound to this, super, and arguments or be used as a constructor.
//  These are all complex topics in themselves but the basic takeaway should be 
//  that arrow functions are simpler in their feature set. You can read more about these differences here.
// The choice of arrow syntax versus function syntax is primarily down to 
// preference and your project's stylistic standards.

// Rest Arguments
// You can use rest syntax to access all the passed arguments as an array. 
// This isn't necessary for this problem, but it will be a critical concept for
//  many problems. You can read more about ... syntax here.
...
// Why
// It may not be immediately obvious why you would use this syntax because
//  you can always just pass an array and get the same result.

// The primary use-case is for creating generic factory functions that accept
//  any function as input and return a new version of the function with some specific modification.
